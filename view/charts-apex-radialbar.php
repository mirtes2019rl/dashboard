...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex RadialBar Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="basic-radialbar" class="apex-charts" data-colors="#35b8e0"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="multiple-radialbar" class="apex-charts" data-colors="#10c469,#6c757d,#ff5b5b,#f9c851"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            <div id="circle-angle-radial" class="apex-charts" data-colors="#536de6,#e3eaef,#10c469,#35b8e0"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="stroked-guage-radial" class="apex-charts" data-colors="#ff5b5b"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="gradient-chart" class="apex-charts" data-colors="#536de6,#35b8e0"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
