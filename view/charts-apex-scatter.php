...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex Scatter Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="basic-scatter" class="apex-charts" data-colors="#536de6,#f9c851,#ff5b5b"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="datetime-scatter" class="apex-charts" data-colors="#6c757d,#10c469,#536de6,#f9c851,#ff5b5b"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
