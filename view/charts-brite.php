...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Brite Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="bar-container" style="width: 100%;height: 300px;" data-colors="#536de6"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="bar-container-horizontal" style="width: 100%;height: 300px;" data-colors="#536de6,#10c469,#6c757d,#ff5b5b,#f9c851,#35b8e0,#e3eaef"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
