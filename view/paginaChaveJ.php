...
<html lang="pt-br">
    <head>
        <meta charset="utf-8" />
        <title>Chave J | Dashboard Mais valor</title>
    ...
    <!-- chamada ao css -->
        ...
        <link  href = "assets/css /vendor/select.bootstrap4.css" rel ="folha de estilo" type = "text/css"/>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Chave j</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Cadastro de chave j </h4></br>
                                </div>
                            </div>
                        </div>     
                    <!-- efim do titulo da pagina--> 
...
<!------------------------------------FIM DO CONTEUDO DA PAGINA ------------------------------->
    ...
    <!------------------------configurações da Barra lateral esquerda---------------------------->
...
<script src ="recursos/js/ fornecedor / dataTables.select.min.js" ></script >
