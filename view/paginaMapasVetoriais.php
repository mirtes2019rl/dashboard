...
<html lang="pt-br">
    <head>
        <meta charset="utf-8" />
        <title>Mapas vetoriais | Dashboard Mais valor</title>
                ...
                <div class="left-side-menu left-side-menu-detached">
                    ...
                    <ul class="metismenu side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                <li>
                                  <a href="apps-ecommerce-products.html">Coban </a>
                                </li>

                                <li>
                                    <a href="apps-ecommerce-products-details.html">Convênios</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-orders.html">Produtos</a>
                                </li>
                                ...
                                <li class="side-nav-item">
                                    ...
                                    <ul class="side-nav-third-level" aria-expanded="false">
                                        <li>
                                            <a href="pages-login.html">Convênio</a>
                                        </li>
                                        <li>
                                            <a href="pages-login-2.html">Convênio e produto</a>
                                        </li>
                                        <li>
                                          <a href="pages-register.html">Produto</a>
                                        </li>
                                        <li>
                                            <a href="pages-register-2.html">Taxa e prazo</a>
                                        </li> 
                                    </ul>
                                </li>

                                <li>
                                    <a href="pages-starter.html">Metas</a>
                                </li>
                                ...
                                <li>
                                    <a href="pages-timeline.html">Chave J</a>
                                </li>
                                <li>
                                    <a href="pages-timeline.html">Equipes </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                ...
                                <li>
                                    <a href="form-fileuploads.html">Upload de arquivo</a>
                                </li> 
                            </ul>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                ...
                                <li>
                                    <a href="maps-vector.html">Mapas Vetorizados</a>
                                </li>
                            </ul>
                        </li>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">mapas vetoriais</li>
                                        </ol>
                                    </div>
                                   <h4 class="page-title">mapas vetoriais</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
