...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Sparkline Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4">
                                            <div id="sparkline1" data-colors="#f9c851,#35b8e0"></div>
                                        </div>
                                    </div> <!-- end card-body -->
                                </div> <!-- card -->
                            </div> <!-- end col -->
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4">
                                            <div id="sparkline2" class="text-center" data-colors="#10c469"></div>
                                        </div>
                                    </div> <!-- end card-body -->
                                </div> <!-- card -->
                            </div> <!-- end col -->
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4">
                                            <div id="sparkline3" class="text-center" data-colors="#35b8e0,#536de6,#e3eaef,#ff5b5b"></div>
                                        </div>
                                    </div> <!-- end card-body -->
                                </div> <!-- card -->
                            </div> <!-- end col -->
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4">
                                            <div id="sparkline4" class="text-center" data-colors="#536de6,#4eb7eb"></div>
                                        </div>
                                    </div> <!-- end card-body -->
                                </div> <!-- card -->
                            </div> <!-- end col -->
