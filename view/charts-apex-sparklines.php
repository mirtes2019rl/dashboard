...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex Sparklines Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div id="spark1" class="apex-charts" data-colors="#6c757d"></div>
                                            </div>
                                            <div class="col-md-4">
                                                <div id="spark2" class="apex-charts" data-colors="#DCE6EC"></div>
                                            </div>
                                            <div class="col-md-4">
                                                <div id="spark3" class="apex-charts" data-colors="#35b8e0"></div>
                                            </div>
                                        </div>
                                        <!-- end row -->
                                                    ...
                                                    <table class="table table-centered mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>15%</td>
                                                                <td>
                                                                    <div id="chart1" data-colors="#536de6"></div>
                                                                </td>
                                                                <td>
                                                                    <div id="chart5" data-colors="#536de6"></div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>$23,533</td>
