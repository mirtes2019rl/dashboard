...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex Bar Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="basic-bar" class="apex-charts" data-colors="#536de6"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="grouped-bar" class="apex-charts" data-colors="#35b8e0,#6c757d"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="stacked-bar" class="apex-charts" data-colors="#10c469,#ff5b5b,#35b8e0,#6c757d,#536de6"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="full-stacked-bar" class="apex-charts" data-colors="#f9c851,#536de6,#6c757d,#e3eaef,#10c469"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="negative-bar" class="apex-charts" data-colors="#35b8e0,#ff5b5b"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="timeline-chart" class="apex-charts" data-colors="#10c469,#ff5b5b"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="datalables-bar" class="apex-charts" data-colors="#10c469,#ff5b5b,#35b8e0,#6c757d,#536de6,#2b908f,#f9c851,#90ee7e,#f48024,#212730"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="pattern-bar" class="apex-charts" data-colors="#10c469,#ff5b5b,#35b8e0,#536de6"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
