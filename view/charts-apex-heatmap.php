...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex Heatmap Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="basic-heatmap" class="apex-charts" data-colors="#536de6"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="multiple-series-heatmap" class="apex-charts" data-colors="#10c469,#F27036,#663F59,#6A6E94,#4E88B4,#00A7C6,#18D8D8,#A9D794,#46AF78"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="color-range-heatmap" class="apex-charts" data-colors="#ff5b5b,#f9c851,#35b8e0,#10c469"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="rounded-heatmap" class="apex-charts" data-colors="#35b8e0,#f9c851"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
