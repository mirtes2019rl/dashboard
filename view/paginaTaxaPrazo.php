...
<html lang="pt-br">
    <head>
        <meta charset="utf-8" />
        <title>Cadastro de Taxa e prazo | Dashboard Mais valor</title>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Taxa e prazo</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Cadastro de comissão por taxa e prazo</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
