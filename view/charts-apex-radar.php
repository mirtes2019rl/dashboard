...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex Radar Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="basic-radar" class="apex-charts" data-colors="#536de6"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="radar-polygon" class="apex-charts" data-colors="#ff5b5b"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="radar-multiple-series" class="apex-charts" data-colors="#536de6,#10c469,#ff5b5b"></div>
