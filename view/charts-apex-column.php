...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex Column Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="stacked-column" class="apex-charts" data-colors="#10c469,#35b8e0,#e3eaef"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="full-stacked-column" class="apex-charts" data-colors="#536de6,#f9c851,#e3eaef"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="negative-value-column" class="apex-charts" data-colors="#536de6"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="distributed-column" class="apex-charts" data-colors="#536de6,#f9c851,#35b8e0,#ff5b5b,#10c469,#6c757d,#e3eaef,#313a46"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
