...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex Candlestick Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="combo-bar-candlestick" class="apex-charts" data-colors="#6c757d,#35b8e0"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
