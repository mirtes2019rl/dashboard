...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex Area Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="basic-area" class="apex-charts" data-colors="#f9c851"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="spline-area" class="apex-charts" data-colors="#536de6,#eef2f7"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="area-chart-negative" class="apex-charts" data-colors="#10c469,#35b8e0"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="area-chart-github" class="apex-charts" data-colors="#10c469"></div>
                                        <div class="pt-2 pb-2">
                                        ...
                                        <div id="area-chart-github2" class="apex-charts" data-colors="#ff5b5b"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="stacked-area" class="apex-charts" data-colors="#536de6,#10c469,#e3eaef"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="area-timeSeries" class="apex-charts" data-colors="#ff5b5b,#eef2f7,#35b8e0"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="area-chart-nullvalues" class="apex-charts" data-colors="#f9c851"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
