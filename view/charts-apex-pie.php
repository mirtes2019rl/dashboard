...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex Pie Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="gradient-donut" class="apex-charts" data-colors="#35b8e0,#6c757d,#10c469,#ff5b5b,#e3eaef"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="image-pie" class="apex-charts" data-colors="#39afd1,#ffbc00,#35b8e0,#10c469"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="update-donut" class="apex-charts" data-colors="#35b8e0,#6c757d,#10c469,#ff5b5b"></div>
