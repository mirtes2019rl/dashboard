...
<html lang="pt-br">
    <head>
        <meta charset="utf-8" />
        <title>Cadastro coban | Dashboard Mais valor</title>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Coban</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Cadastro coban</h4>
                                </div>
                            </div>
                        </div>     
        ...
        <tr>
            ...
            <td>
                ...
                <div>
                    ...
                    <label for="switch2" data-on-label="Sim" data-off-label="Não" class="mb-0 d-block"></label>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <div>
                    ...
                    <label for="switch3" data-on-label="Sim" data-off-label="Não" class="mb-0 d-block"></label>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <div>
                    ...
                    <label for="switch4" data-on-label="Sim" data-off-label="Não" class="mb-0 d-block"></label>
                </div>
            </td>
        </tr>
    </tbody>
