...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Apex Bubble Charts | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="simple-bubble" class="apex-charts" data-colors="#536de6,#10c469,#fa5c7c"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="second-bubble" class="apex-charts" data-colors="#536de6,#f9c851,#35b8e0,#ff5b5b"></div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                <!-- end card -->
